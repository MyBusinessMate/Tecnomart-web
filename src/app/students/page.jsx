  ...
  return (
    <SmoothScrollProvider>
      ...
      <main className="min-h-screen bg-[#f7f8fa] pb-24 lg:pb-0">
        ...
        {/* Bottom CTA */}
        <section className="px-4 sm:px-6 lg:px-8 max-w-2xl mx-auto pb-16">
          <BlurRevealBox delay={0.1}>
            <div className="bg-midgrey-900 rounded-2xl border border-midgrey-700/60 p-6 sm:p-8 relative overflow-hidden text-center shadow-lg">
              <div className="absolute inset-0 bg-amber-500/5 pointer-events-none" />
              <div className="relative z-10">
                <div className="w-12 h-12 rounded-xl bg-amber-500/20 text-amber-400 flex items-center justify-center mx-auto mb-3.5 border border-amber-500/30">
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 bg-emerald-500 hover:bg-emerald-600 active:scale-98 text-white font-black text-xs sm:text-sm px-6 py-3 rounded-xl shadow-md transition-all cursor-pointer uppercase tracking-wide"
                >
