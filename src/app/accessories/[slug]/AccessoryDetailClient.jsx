              ...
              <div className="lg:col-span-6 space-y-6">
                ...
                <div className="p-4 rounded-2xl bg-neutral-50 border border-neutral-200 space-y-2.5">
                  ...
                  <form onSubmit={handleCheckPincode} className="flex gap-2">
                    ...
                    />
                    <button type="submit" className="px-4 bg-midgrey-900 hover:bg-midgrey-800 text-white text-xs font-bold uppercase rounded-xl transition-colors cursor-pointer shadow-sm">
                      Check
                    </button>
                  </form>
