...
export const ACCESSORIES_DATA = [
  {
    id: "a1",
    slug: "alienware-32-4k-oled-monitor",
    name: "Alienware 32\" 4K QD-OLED Gaming Monitor (AW3225QF)",
    brand: "Dell Alienware",
    category: "Monitors",
    tagline: "4K 240Hz Curved QD-OLED. 0.03ms response time. Dolby Vision HDR.",
    price: "₹95,999",
    originalPrice: "₹1,09,999",
    rawPrice: 95999,
    discountPercent: "13% OFF",
    emiText: "No-cost EMI starting at ₹7,999/month",
    badge: "BEST MONITOR 2025",
    badgeColor: "bg-amber-500 text-neutral-950 font-black",
    rating: 4.9,
    reviewCount: 54,
    stockStatus: "In Stock at Tolichowki Store",
    ...
    keyHighlights: [
      ...
      "Blazing fast 0.03ms gray-to-gray response time eliminates motion blur completely",
      "VESA DisplayHDR True Black 400 and Dolby Vision for infinite contrast",
    ],
    specs: {
      "Screen Size": "31.6 inches Curved 1700R QD-OLED",
      "Resolution & Refresh": "3840 x 2160 at 240Hz (HDMI 2.1 / DP 1.4)",
      "Response Time": "0.03ms (Gray-to-Gray)",
      "Color Gamut": "99% DCI-P3, 1000 nits peak brightness",
    },
    inTheBox: ["Alienware AW3225QF", "DisplayPort Cable", "HDMI 2.1 Cable", "Power Cable"],
    reviews: []
  },
  {
    id: "a2",
    ...
    inTheBox: ["G PRO X Superlight 2", "LIGHTSPEED Wireless Receiver", "USB-C Cable"],
    reviews: []
  }
];
...
export const REFURBISHED_DATA = [
  ...
  },
  {
    ...
    name: "Certified Refurbished iPhone 14 Pro 128GB",
    brand: "Apple Certified Grade A+",
    category: "Refurbished Mobiles",
    tagline: "Dynamic Island. 48MP camera. 100% Genuine original parts.",
    price: "₹64,999",
    ...
    inTheBox: ["Refurbished iPhone 14 Pro", "Lightning to USB-C Cable", "Warranty Invoice"],
    reviews: []
  }
];
