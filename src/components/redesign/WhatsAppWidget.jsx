  ...
  return (
    <div className="fixed bottom-20 right-4 lg:bottom-8 lg:right-6 z-50 group">
      ...
      <button
        ...
        className="relative w-14 h-14 rounded-full bg-emerald-500 hover:bg-emerald-600 active:scale-95 shadow-xl transition-all duration-200 cursor-pointer flex items-center justify-center"
      >
        {/* Pulsing ring */}
